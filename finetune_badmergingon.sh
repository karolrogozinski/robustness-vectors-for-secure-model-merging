...
for dataset in "${DATASETS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0 python3 src/ut_badmergingon.py --adversary-task $dataset --model "ViT-B-32" --target-cls 1 --mask-length 22 --seed 1
    CUDA_VISIBLE_DEVICES=0 python3 src/finetune_backdoor_badmergingon.py --adversary-task $dataset --model "ViT-B-32" --target-cls 1 --patch-size 22 --alpha 5 --seed 1
done
# done
