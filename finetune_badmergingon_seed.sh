DATASETS=("ImageNet100" "Cars" "EuroSAT" "GTSRB" "PETS" "SUN397" "CIFAR100" )
...
for i in {2..5}; do
    for dataset in "${DATASETS[@]}"; do
        ...
        echo $dataset $i
        echo "********************************************" 
        CUDA_VISIBLE_DEVICES=2 python3 src/finetune_backdoor_badmergingon.py --adversary-task $dataset --model "ViT-L-14" --target-cls 1 --patch-size 22 --alpha 5 --seed $i
    done
done
